        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-bold">
                    <i class="fa fa-align-justify"></i> Edit Shop Owner&nbsp;&nbsp;
                ...
                <div class="card-block">
                    ...
                    @endif
                    <form action="{{url('/shop-owner/update')}}" 
                    ...
                    >
                        {{csrf_field()}}
                        <input type="hidden" name="id" id="id" value="{{$shop_owner->id}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                <select class="form-control" name="gender" id="gender"  id="exampleSelect1">
                                     <option 
                                        value="Male" 
                                        {{$shop_owner->gender=='Male'?'selected':''}}
                                    >
                                        Male 
                                    </option>
                                    <option 
                                        value="Female" 
                                        {{$shop_owner->gender=='Female'?'selected':''}}
                                    >
                                        Female
                                    </option>              
                                </select>
